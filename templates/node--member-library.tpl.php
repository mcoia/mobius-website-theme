...
<article id="node-<?php print $node->nid; ?>" class="<?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  ...
  <div<?php print $content_attributes; ?>>
    ...
    <h2>Library Contacts</h2>
    <div class="container">
      <div class="row">
    <?php 
          $num_contacts = count($content['field_contact']['#items']);
          for($i = 0; $i < $num_contacts; $i++) {
            $contact_collection =  $content['field_contact'][$i]['entity']['field_collection_item'];
	...
	<div class="row">
    <?php
	foreach($content['field_location']['#items'] as $location): ?>
	  <div class="col-md-4 col-sm-6 col-xs-12 adr">
	    <div class="location vcard">
	    <h4><span class="fn" itemprop="name"><?php echo $location['name']; ?></span></h4>
	    <div class="street-address">
		<span itemprop="streetAddress"><?php echo $location['street']; ?></span>
	    </div>
	    <span class="locality" itemprop="addressLocality"><?php echo $location['city']; ?></span><span class="region" itemprop="addressRegion">, <?php echo $location['province'];?></span>
	    <span class="postal-code" itemprop="postalCode">
		<?php echo $location['postal_code']; ?>
	    </span>
	    <div class="map-link">
		See map: <a href="http://maps.google.com/?q=<?php echo $location['latitude'];?>+<?php echo $location['longitude'];?>+%28<?php echo urlencode($location['street'] . ',' . $location['city'] . ',' . $location['province'] . ',' . $location['postal_code']);?>">Google Maps</a>	
	    </div>
	    </div><!--/location-->
	  </div><!--/col-->
    	<?php endforeach; ?> 
